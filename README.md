...
```
sudo bash -c "$(curl -L https://raw.githubusercontent.com/YoungDeveloper2025/xray-reality/master/install.sh)"
``` 
and it will do the rest for you.

## Uninstallation guide
```
sudo bash -c "$(curl -L https://raw.githubusercontent.com/YoungDeveloper2025/xray-reality/master/uninstall.sh)"
``` 
